...
import { ItemProvider } from './ItemProvider.js'; //will remove when new functionality migrated to AccessoryProvider
...
export function startOpenHABBridge() {
  ...
  let ops = stdio.getopt({
      'name'   : {key: 'n', args: 1, description: 'The name of the bridge.', mandatory: true},
