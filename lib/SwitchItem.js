...
class SwitchItem {
  constructor(name, url, state) {
    ...
    this.services = [{
      sType: this.types.ACCESSORY_INFORMATION_STYPE,
      characteristics: [{
      	cType: this.types.NAME_CTYPE,
      	onUpdate: null,
      	perms: ["pr"],
    		format: "string",
    		initialValue: name,
      	...
      	cType: this.types.MANUFACTURER_CTYPE,
      	onUpdate: null,
      	perms: ["pr"],
    		format: "string",
      	...
      	cType: this.types.SERIAL_NUMBER_CTYPE,
      	onUpdate: null,
      	perms: ["pr"],
    		format: "string",
    		initialValue: "<sn>",
      	...
      	cType: this.types.IDENTIFY_CTYPE,
      	onUpdate: null,
      	perms: ["pw"],
    		format: "bool",
    		initialValue: false,
      ...
      characteristics: [{
      	...
      	cType: this.types.POWER_STATE_CTYPE,
